							...
							<div class="form-row">
								<div class="col-9 mt-2" id=signDivEmail>
									<label for="signInputEmail">이메일</label> <input type="text"
										...
										placeholder="이메일형식을 입력하세요" oninput=emailOverlapCheck()>
						...
						<div class="form-group">
							<div class="form-row col-12">
								<div class="col-6">
									<label for="">아이디</label> <input type="text" id=signInputID
										...
										placeholder="고유한 아이디를 입력하세요" oninput=nickNameOverlapCheck()>
									<div class="valid-feedback ml-3">Ok</div>
									<div class="invalid-feedback ml-3">Not Ok</div>
								</div>
								<div class="col-6">
							...
							<div class="form-row col-12 mt-2">
								<label for="">전화번호</label> <input type="text"
									id="signInputPhone" name=mb_phone class="form-control"
							...
							<div class="form-row col-12 mt-2">
								<label for="">그룹</label> <input type="text" id="signInputGroup"
									name=mb_group class="form-control" placeholder="이름을 입력하세요">
								<div class="valid-feedback ml-3">Ok</div>
								<div class="invalid-feedback ml-3">Not Ok</div>
							</div>
						</div>
...
<!-- 회원가입 메뉴 -->
	...
	<script>
		...
		function validate() {
			...
			//이메일과 비밀번호랑 같은지
			if ($("#signInputEmail").val() == ($("#signInputPassword").val())
					&& !naverKakao) {
			...
			//비밀번호와 확인이 같은지
			if ($("#signInputPassword").val() != ($("#signRepeatPassword")
					.val())
					&& !naverKakao) {
				alert("비밀번호가 같지않습니다.");
				$("#signInputPassword").val("");
